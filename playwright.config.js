...
const backendEnv = {
  ...
  API_KEY_PEPPER: 'playwright-e2e-api-key-pepper-separate-from-jwt-secret',
  STELLAR_NETWORK: 'testnet',
  USDC_ISSUER: 'GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5',
  PLATFORM_SECRET_KEY: 'SCVMQUS5EMTHWBLJTE5XCSCMHB2ZOVKRR4ATVTRPUNRCOGKRENIL3LHR',
  ARBITRATOR_SECRET_KEY: 'SCVMQUS5EMTHWBLJTE5XCSCMHB2ZOVKRR4ATVTRPUNRCOGKRENIL3LHR',
  STELLAR_HORIZON_URL: 'https://horizon-testnet.stellar.org',
  WALLET_SECRET_LOCAL_KEK: 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=',
  WALLET_ENCRYPTION_KEY: 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=',
  OPS_API_KEY: 'playwright-e2e-ops-api-key',
  UNSUBSCRIBE_SECRET: 'playwright-e2e-unsubscribe-secret',
  IMPACT_SIGNING_SECRET: 'playwright-e2e-impact-signing-secret',
